...
`
            ...
            case 'group': case 'grup': {
                ...
                if (!isAdmins) return replay(`${mess.admin}`)
                if (args[0] === 'close') {
                    await Kurome.groupSettingUpdate(m.chat, 'announcement').then((res) => reply(`Grupo Fechado`)).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'open') {
                    await Kurome.groupSettingUpdate(m.chat, 'not_announcement').then((res) => reply(`Grupo Aberto`)).catch((err) => reply(jsonformat(err)))
                } else {
                    let buttons = [
                    ...
                    await Kurome.sendButtonText(m.chat, buttons, `Modo Do Grupo`, Kurome.user.name, m)
            ...
            case 'editinfo': {
                ...
                if (!isAdmins) return replay(`${mess.admin}`)
                if (args[0] === 'open') {
                    await Kurome.groupSettingUpdate(m.chat, 'unlocked').then((res) => reply(`Todos Podem Editar A desc do Grupo`)).catch((err) => reply(jsonformat(err)))
                } else if (args[0] === 'close') {
                    await Kurome.groupSettingUpdate(m.chat, 'locked').then((res) => reply(`Apenas ADMS Podem Editar A desc do Grupo`)).catch((err) => reply(jsonformat(err)))
                } else {
                    let buttons = [
                    ...
                    await Kurome.sendButtonText(m.chat, buttons, `Modo De Edição do Grupo`, Kurome.user.name, m)
            ...
            case 'mute': {
                ...
                if (args[0] === "on") {
                    ...
                    reply(`${Kurome.user.name} Mutada Neste Grupo!`)
                } else if (args[0] === "off") {
                    if (!db.data.chats[m.chat].mute) return reply(`Previously Inactive`)
                    db.data.chats[m.chat].mute = false
                    reply(`${Kurome.user.name} Desmutada Neste Grupo!`)
                } else {
                    let buttons = [
                        { buttonId: prefix + 'mute on', buttonText: { displayText: 'On' }, type: 1 },
                        { buttonId: prefix + 'mute off', buttonText: { displayText: 'Off' }, type: 1 }
                    ]
                    await Kurome.sendButtonText(m.chat, buttons, `Mutar Bot Neste Grupo?`, Kurome.user.name, m)
                }
            }
                break
...
Report Message: ${text}`
            ...
            case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'cheems': case 'doge': {
                ...
                let buttonMessage = {
                    image: { url: 'https://telegra.ph/file/4b66d245b1af034a402a8.jpg' },
                    caption: `
┌─❖
│「 Olá 👋 」
│「 ${pushname} 」
            ...
            case 'command': {
                ...
                },
                {
                    ...
                    "rows": [
                        ...
                        {
                            "title": "Menu Download",
                            "description": "Comandos de Downloads",
                    ...
                    "rows": [
...

                        {
                            ...
                            "description": "Comandos de conversão de Mídia",
                            "rowId": `${prefix}menuconverter`
                        },
                        {
                            "title": "Menu de Voz",
                            "description": "Modificadores de Voz",
                            "rowId": `${prefix}menudevoz`
                        },
                        {
                        ...
                        {
                            "title": "Menu Menu Brincadeiras",
                            "description": "Comandos de brincadeiras",
                            "rowId": `${prefix}menubrincar`
                        },
                    ]
                },
                {
...
✙ Segue O Menu Abaixo`,
            ...
            case 'menuinformativo': {
                let buttonMessage = {
                    image: { url: 'https://telegra.ph/file/bde8ae06a6d5fc4330c67.jpg' },
                    caption:
                        `  
┏━「 ${botname} 」━━⭓ 
╔┅═┅═══ ᐃᐁᐃ ══┅═┅═᳀
...
┗━━「 ${pushname} 」━⭓`,
                ...
                case 'menugrupo': {
                    let buttonMessage = {
                        image: { url: 'https://telegra.ph/file/58f100a934eaba94a3227.jpg' },
                        caption:
                            `  
┏━「 ${botname} 」━━⭓ 
╔┅═┅═══ ᐃᐁᐃ ══┅═┅═᳀
...
┗━━「 ${pushname} 」━⭓`,
                    ...
                    case 'menudono': {
                        let buttonMessage = {
                            image: { url: 'https://telegra.ph/file/54fdddb5e894dcc9914f1.jpg' },
                            caption:
                                `  
┏━「 ${botname} 」━━⭓ 
╔┅═┅═══ ᐃᐁᐃ ══┅═┅═᳀
...
┃${prefix}perfilbot -troca a foto do bot
...
┗━━「 ${pushname} 」━⭓`,
                        ...
                        case 'menudownload': {
                            let buttonMessage = {
                                image: { url: 'https://telegra.ph/file/ff23358e04cac543c0d62.jpg' },
                                caption:
                                    `  
┏━「 ${botname} 」━━⭓ 
╔┅═┅═══ ᐃᐁᐃ ══┅═┅═᳀
...
┗━━「 ${pushname} 」━⭓`,
                ...
                case 'menuanime': {
                    let buttonMessage = {
                        image: { url: 'https://telegra.ph/file/0da538fe3564c557492f8.jpg' },
                        caption:
                            `  
┏━「 ${botname} 」━━⭓ 
╔┅═┅═══ ᐃᐁᐃ ══┅═┅═᳀
...
┗━━「 ${pushname} 」━⭓`,
                    ...
                    case 'menufig': {
                        let buttonMessage = {
                            image: { url: 'https://telegra.ph/file/16b862c352ce2dfaf68c7.jpg' },
                            caption:
                                `  
┏━「 ${botname} 」━━⭓ 
╔┅═┅═══ ᐃᐁᐃ ══┅═┅═᳀
...
┗━━「 ${pushname} 」━⭓`,
                        ...
                        case 'menuconverter': {
                            let buttonMessage = {
                                image: { url: 'https://telegra.ph/file/76159aebc813a8f80a025.jpg' },
                                caption:
                                    `  
┏━「 ${botname} 」━━⭓ 
╔┅═┅═══ ᐃᐁᐃ ══┅═┅═᳀
...
┗━━「 ${pushname} 」━⭓`,
                                ...
                                case 'interagir': {
                                    let buttonMessage = {
                                        image: { url: 'https://telegra.ph/file/340476630ac4dc63b28b7.jpg' },
                                        caption:
                                            `  
┏━「 ${botname} 」━━⭓ 
╔┅═┅═══ ᐃᐁᐃ ══┅═┅═᳀
...
┗━━「 ${pushname} 」━⭓`,
 ...
 case 'kkk':{
 if (!isAdmins === false){
    result = fs.readFileSync(`./KuromeMedia/vn/Bah.mp3`)
    Kurome.sendMessage(m.chat, { audio: result, mimetype: 'audio/mp4', ptt: true }, { quoted: m })  
 }else{
    result = fs.readFileSync(`./KuromeMedia/vn/Baka.mp3`)
    Kurome.sendMessage(m.chat, { audio: result, mimetype: 'audio/mp4', ptt: true }, { quoted: m }) 
 }
