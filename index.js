...
const { state, saveCreds } = await useMultiFileAuthState(`./${sessionName}`)
    ...
    const Kurome = XeonBotIncConnect({
        ...
        browser: ['Kurome V4 Beta','Safari','1.0.0'],
        auth: state
    })
...
Kon = await getBuffer(`https://telegra.ph/file/948f78fac08984c283a19.jpg`)

Tol = await getBuffer(`https://telegra.ph/file/948f78fac08984c283a19.jpg`)
                if (anu.action == 'add') {
